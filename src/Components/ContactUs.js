          ...
          >
            <div className="max-w-[570px] mb-12 lg:mb-0 mx-auto">
              ...
              <p className="lg:py-6 sm:py-3 ">
                For business enquiry, please fill the form. We would love to
                hear your comments and questions.Your cooperation is much
                appreciated.
              </p>
            </div>
          </div>
            ...
            <div className="bg-gray-100 dark:bg-slate-800 relative rounded-lg p-8 sm:p-12 shadow-lg">
              <form onSubmit={sendEmail}>
                ...
                <div>
                  <button
                    type="submit"
                    className="btn bg-[#FF8A65] text-black hover:text-white"
                  >
                    Submit
                  </button>
                </div>
